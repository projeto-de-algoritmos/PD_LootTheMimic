...
class Button:
    def __init__(self, text, color, x, y, width, height):
        ...
        self.width = width
        self.height = height
        self.font = pygame.font.Font(None, 24)  # you can adjust the size as per your need

    def draw(self, screen):
        pygame.draw.rect(screen, self.color, (self.x, self.y, self.width, self.height))
        text_surface = self.font.render(self.text, True, (0, 0, 0))  # assuming black color for button text
